...
class Settings:
	...
	def __init__(self):
		...
		if self.computer == 'kontoret':  # Kontoret (users, , [0, 0])
			...
			self.ul = 300000
			self.delayLambda = 5
		elif self.computer == 'hemma':   # Hemma  (logs, , [3 300 001, 3 400 000])
			self.runlocal = True
		...
		elif self.computer == 'toshiban':   # Toshiban (month, , [900 001, 1 000 000])
			self.scrapeMonths = True
			self.ll = 900001
			self.ul = 1000000
			...
			self.bannedIP = '60.241.126.187'
		#VBOXES
		elif self.computer == 'vbox1':   # Vbox1  (months, , [800 001, 900 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.ll = 800001
			self.ul = 900000
		elif self.computer == 'vbox2':   # Vbox2  (months, , [700 001, 800 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.ll = 700001
			self.ul = 800000
		elif self.computer == 'vbox3':   # Vbox3  (logs, , [3 200 001, 3 300 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeLogs = True
			self.ll = 3200001
		...
		elif self.computer == 'vbox7':   # Vbox7  (months, odd, [300 001, 400 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.onlyEven = False
			self.ll = 300001
			self.ul = 400000
		elif self.computer == 'vbox8':   # Vbox8  (months, , [1 000 001, 1 100 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.ll = 1000001
		...
		elif self.computer == 'vbox9':   # Vbox9  (months, even, [1 800 000, 4 000 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.onlyEven = True
			self.ll = 1800001
			self.ul = 4000000
		elif self.computer == 'vbox10':   # Vbox10  (months, odd, [400 001, 500 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.onlyEven = False
			self.ll = 400001
			self.ul = 500000
		elif self.computer == 'vbox11':   # Vbox11  (fill, , [1, 4 000 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.fillMonths = True
			self.ll = 0
			self.ul = 4000000
		elif self.computer == 'vbox12':   # Vbox12  (logs, , [3 500 001, 3 600 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeLogs = True
			self.ll = 3500001
			...
			self.ll = 3400001
			self.ul = 3500000
		elif self.computer == 'vbox15':   # Vbox15  (month, odd, [1 800 001, 4 000 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.onlyEven = False
