...
class Settings:
	...
	def __init__(self):
		...
		if self.computer == 'kontoret':  # Kontoret (users, , [0, 0])
		...
		elif self.computer == 'toshiban':   # Toshiban (users, , [1, 1 200 000])
			self.scrapeUsers = True
			self.ll = 1
			self.ul = 1200000
			...
			self.bannedIP = '60.241.126.187'
		#VBOXES
		elif self.computer == 'vbox1':   # Vbox1  (users, , [1 900 001, 3 400 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeUsers = True
			self.ll = 1900001
		...
		elif self.computer == 'vbox16':   # Vbox16  (user, , [1 500 001, 1 700 000])
			#self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeUsers = True
			#self.onlyEven = True
