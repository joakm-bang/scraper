...
class Settings:
	...
	def __init__(self):
		...
		elif self.computer == 'toshiban':   # Toshiban (users, , [1, 3 400 000])
			self.scrapeUsers = True
			self.ll = 1
			self.ul = 3400000
		...
		#VBOXES
			...
			self.ll = 700001
			self.ul = 900000
		elif self.computer == 'vbox3':   # Vbox3  (fill, , [400 001, 500 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.fillMonths = True
			self.ll = 400001
			self.ul = 500000
		elif self.computer == 'vbox4':   # Vbox4  (users, , [3 400 001, 3 600 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeUsers = True
			self.ll = 3400001
		...
		elif self.computer == 'vbox7':   # Vbox7  (months, , [600 001, 1 800 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.fillMonths = True
			self.ll = 600001
			...
			self.ll = 0
			self.ul = 100000
		elif self.computer == 'vbox14':   # Vbox14  (logs, , [2 200 001, 2 400 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeLogs = True
			self.ll = 2200001
			self.ul = 2400000
		elif self.computer == 'vbox15':   # Vbox15  (logs, , [2 500 001, 2 900 000])
			self.runLAN = True
			self.bannedIP = '60.241.126.187'
			self.scrapeLogs = True
			self.ll = 2500001
			...
			self.ll = 1500001
			self.ul = 1800000
		elif self.computer == 'vbox18':   # Vbox18  (months, , [500 001, 700 000])
			self.bannedIP = '60.241.126.187'
			self.scrapeMonths = True
			self.ll = 500001
			self.ul = 700000
